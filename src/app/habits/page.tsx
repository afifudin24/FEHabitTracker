      ...
      <div className="flex min-h-[100vh] justify-between flex-col">
        <div className="wrapper mt-10">
          <Container className="flex flex-col md:flex-row justify-between gap-3">
            <div data-aos="fade-right" data-aos-duration="1000" className="left md:w-8/12 mt-16 md:mt-0 w-full">
              <BtnSuc onClick={() => console.log('ok')}>
                ...
                <table className="min-w-full bg-bg-card mt-10 table-auto shadow-md rounded-lg overflow-hidden">
                  <thead className="bg-primary">
                    <tr className="text-left text-text-light">
                      ...
                      <th className="px-4 py-3 hidden md:inline-block">Period</th>
                      <th className="px-4 py-3 hidden md:inline-block">Target</th>
                  ...
                  <tbody>
                    {habits.map((habit, index) => (
                      <tr key={habit.id} className="hover:bg-bg-soft border-b border-gray-200">
                        ...
                        <td className="px-4 py-2 hidden md:inline-block">{habit.period}</td>
                        <td className="px-4 py-2 hidden md:inline-block">{habit.target}</td>
            ...
            <div data-aos="fade-left" data-aos-duration="1000" className="right md:w-4/12 mt-6 md:mt-0 w-full">
