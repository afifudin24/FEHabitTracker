...
import { faBars, faRightFromBracket, faTimes, faUser } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-auto bg-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition duration-200 z-10">
                <a href="profile.html" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                  <span className="mr-2">Profile</span> <FontAwesomeIcon icon={faUser} />
                </a>
      ...
      <nav className={`md:hidden block py-4 w-full top-0 z-50  ${isSticky ? 'fixed bg-bg-card shadow-md' : 'shadow-sm fixed'}`}>
        ...
        <div className="h-full py-12 px-4 flex flex-col justify-between items-center">
          ...
          <div className="flex flex-col items-center gap-3">
            <Link href="/profile" className="flex items-center gap-3 text-text-primary no-underline">
              <Image src={imgprofile} alt="profile" className="w-10 h-10 rounded-md object-cover border" />
