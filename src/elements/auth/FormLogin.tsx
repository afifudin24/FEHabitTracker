...
const FormLogin = () => {
    ...
    return (
        <><form className="text-text-primary">
            ...
            <a className="login w-full block text-center  p-3 bg-primary text-text-light border-none rounded-lg text-base cursor-pointer transition-all duration-100 ease-in-out hover:bg-primary-hover"  href="../dashboard/index.html">Login</a>
